...
<body style="background-color:#F0F8FF;">
	<div align="center" style="top:0px">        
		<table width="1200" align="center" class = "t">
			...
			<td style = "text-align:center;border:0px"><a href="transactionhistory.php" target="frame"><button class = "btn2">Details of Transaction History</button></a></td>
			</tr>
        </table>	
<br>
...
<br><br>
	...
	<table border="0px" style="background-color:#75A1D0;">
		...
		<td><select name="user">
			...
			<tr><td></td><td><input type="submit" name="submit" value="Submit" align=center style="margin-top: 10px; width:6em; height:2em; font-size:15px; background-color: tan; font-weight: bold;"></td></tr>
	</table>
